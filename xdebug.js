...
XDebug.prototype.CreateStyle = function() {    
    var style=".xdebug-panel{z-index: 9999;position: absolute;bottom: 0px;height: 300px;display: flex;flex-direction: column;background: #242424;left: 0px;right: 0px;border-top: 1px solid #292a2d;font-size:13px;font-family: Consolas, monospace !important;color:white;}";
